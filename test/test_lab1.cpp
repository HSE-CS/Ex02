...
TEST(task1, test1)
{
    ASSERT_NEAR(2.236067977, calc(5), 0.00000001);
}

TEST(task1, test2)
{
    ASSERT_NEAR(3.0, average(2.0, 4.0), 0.00000001);
}
...
TEST(task1, test5)
{
    ASSERT_NEAR(3.0, calc(9), 0.00000001);
}
...
TEST(task1, test7)
{
    ASSERT_NEAR(2.645751, calc(7), 0.00000001);
}
